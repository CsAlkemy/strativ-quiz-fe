                ...
                <div className="flex flex-col gap-3 justify-center items-center mt-4 mb-7">
                    ...
                    <div className="text-paragraph-m font-regular text-neutral-7 -mt-2">
                        ...
                        <div className="text-center">
                            to <span className="font-medium text-neutral-10">{'al@gmail.com'}</span>
                        </div>
                    </div>
                </div>
                <form onSubmit={hookForm.handleSubmit(onSubmit)}>
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-1 justify-center items-center">
                            <div className="text-paragraph-m font-regular text-neutral-10">{'Didn’t receive the code?'}</div>
