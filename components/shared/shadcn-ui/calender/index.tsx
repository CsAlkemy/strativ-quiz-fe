...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
    return (
        <DayPicker
            ...
            className={cvaCnMerge('p-3 flex justify-center w-full text-black', className)}
            ...
            classNames={{
                ...
                nav_button: cvaCnMerge(buttonVariants({ variant: 'outline' }), 'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100'),
                ...
                day: cvaCnMerge(buttonVariants({ variant: 'ghost' }), 'h-9 w-9 p-0 font-normal aria-selected:opacity-100'),
