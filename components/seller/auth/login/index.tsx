            ...
            <div className="bg-white h-screen flex justify-center items-center">
                <div className="p-7 bg-white rounded-xl w-full max-w-[450px]">
                    <div className="flex flex-col gap-3 justify-center items-start mt-4 mb-7">
                        ...
                        <div className="text-heading-5 font-bold text-neutral-10">Login</div>
                        <div className="text-paragraph-m font-regular text-neutral-7 -mt-2">Please enter your details to continue.</div>
                    </div>
                    <form onSubmit={hookForm.handleSubmit(onSubmit)}>
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center my-4">
                                ...
                                <Link className="text-primary-6 font-regular" href="/seller/auth/forgot-password">
                                    Forgot Password?
                                </Link>
                            </div>
                            ...
                            <div className="flex gap-1 justify-center items-center">
                                ...
                                <Link className="text-primary-6" href="/seller/auth/sign-up">
                                    Sign Up
                                </Link>
                            </div>
                        </div>
